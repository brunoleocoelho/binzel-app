...
namespace BinzelApp2_Prototipo
{
    ...
    public class MenuGerencial : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            this.usr.Matricula = Intent.GetIntExtra("usrMatr", 0);
            this.usr.Nome = Intent.GetStringExtra("usrNome");
            this.usr.Sobrenome = Intent.GetStringExtra("usrSobreNome");
            this.usr.Cargo = Intent.GetStringExtra("usrCargo");
            this.usr.Setor = Intent.GetStringExtra("usrSetor");
            this.usr.NivelAcesso = Intent.GetIntExtra("usrNivel",0);
