...
namespace BinzelApp3_Prototipo
{
    ...
    public class OPDetails : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            OP = Intent.GetStringExtra("NUMOP");
            if (!string.IsNullOrEmpty(OP))
            {
                ...
                userMenu.Text = string.Format("{0}, {1}", usr.Nome, usr.Setor);
            ...
            bld.PutString("OP", OP);
            bld.PutFloat("QtdOP", objOP.QUANTIDADE);
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            if (id == Android.Resource.Id.Home) { //back button
                ...
                intentDesenho.PutExtra("descricao", objOP.NUMOP);
        ...
        private void SetHeaderOPDetails()
        {
            ...
            numOP.Text = objOP.NUMOP;
            //cliente.Text = objOP.Cliente;
            prod.Text = string.Format("{0} ({1})", objOP.CODPRODUTO, objOP.OBSERVACAO);
            ...
            switch (objOP.STATUS)
            {
                ...
                case "S":
                    stsId = Resource.Drawable.sign_green_dot;
                    status.Text = "Sacramentada";
                    break;
                case "U":
                    stsId = Resource.Drawable.sign_red_cancel;
                    status.Text = "Suspensa";
                    break;
                default:
                    stsId = Resource.Drawable.sign_blue_in_process;
                    status.Text = "Normal";
            ...
            dtInicio.Text = objOP.PREVISAOINICIO == "" ? "--/--/----" : objOP.PREVISAOINICIO;
            dtFinal.Text = objOP.PREVISAOENTREGA == "" ? "--/--/----" : objOP.PREVISAOENTREGA;
